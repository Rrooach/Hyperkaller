...
// If you need to build with -static, then the following env needs to be
// exported: UBSAN_OPTIONS="handle_segv=0 handle_sigbus=0 handle_abort=0
// handle_sigill=0 handle_sigtrap=0 handle_sigfpe=0" and the following flags
// added to fuzzer invocation: -handle_fpe=0 -handle_int=0 -handle_term=0
// -handle_xfsz=0 -handle_usr1=0 -handle_usr2=0
